 ...
 * - Header removed; user card lives above Logout in the sidebar
 * - AI Lab navigates to /ai-lab page (modal removed)
 * - Street Explorer added at /street-data
 */
...
import {
  ...
  FiCalendar, FiLayers, FiBarChart2, FiHome, FiCpu, FiArchive,
} from 'react-icons/fi';
...
export default function Layout({ children }) {
  ...
  const navItems = [
    ...
    { icon: FiArchive,  label: 'Data House',        path: '/data-house',   allowedRoles: ['super_admin', 'municipality_admin', 'supervisor', 'field_inspector', 'auditor', 'operator', 'admin', 'user'] },
    ...
    { icon: FiCpu,      label: 'AI Lab',            path: '/ai-lab',       allowedRoles: ['super_admin', 'municipality_admin', 'supervisor', 'field_inspector', 'auditor', 'operator', 'admin', 'user'] },
