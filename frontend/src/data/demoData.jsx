...
export const DEMO_VIOLATION_DISTRICT = [
  { name: 'Al Haram',    value: 23 },
  { name: 'Quba',        value: 17 },
  { name: 'Al Manakhah', value: 14 },
  { name: 'Jabal Uhud',  value: 10 },
  { name: 'Aziziyah',   value: 8  },
  { name: 'Al Awali',   value: 6  },
];
...
export const DEMO_TASKS = [
  {
    id: 'T-081',
    title: 'Inspect spice market stalls',
    status: 'Assigned',
    district: 'Al Haram',
  ...
  {
    id: 'T-054',
    title: 'Review AI findings — Quba commercial strip',
    status: 'In Progress',
    district: 'Quba',
  ...
  {
    id: 'T-120',
    title: 'Schedule Manakhah plaza walkthrough',
    status: 'Planned',
    district: 'Al Manakhah',
  ...
  {
    id: 'T-099',
    title: 'Validate license sync — Aziziyah zone',
    status: 'Completed',
    district: 'Aziziyah',
  ...
  {
    id: 'T-103',
    title: 'Encroachment audit — Jabal Uhud road',
    status: 'Assigned',
    district: 'Jabal Uhud',
    assignment: 'Field Inspector Khalid',
    due: 'Today 14:00',
    priority: 'High',
  },
];
...
export const DEMO_SCHEDULE = [
  ...
  { inspector: 'Fatima Zahra',   shift: '10:00 - 18:00', status: 'Scheduled',  area: 'Quba'        },
  { inspector: 'Youssef Malik',  shift: '14:00 - 22:00', status: 'On Leave',   area: 'Al Manakhah' },
  { inspector: 'Sara Hadi',      shift: '06:00 - 14:00', status: 'On Call',    area: 'Aziziyah'    },
  { inspector: 'Khalid Rahman',  shift: '08:00 - 16:00', status: 'On Duty',    area: 'Jabal Uhud'  },
  { inspector: 'Mariam Nasser',  shift: '12:00 - 20:00', status: 'Scheduled',  area: 'Al Awali'    },
];
...
export const DEMO_BUILDINGS = [
  {
    id: 'B-01',
    name: 'Al Haram Commercial Centre',
